...
const styles = {
  ...
  preview: 'relative h-28 overflow-hidden rounded-xl border border-white/10 p-3',
  previewSurface: 'h-full rounded-lg border border-white/10 p-3 shadow-lg',
  previewAccent: 'h-3 w-16 rounded-full',
  previewLine: 'mt-3 h-2 w-4/5 rounded-full bg-white/30',
  previewLineShort: 'mt-2 h-2 w-1/2 rounded-full bg-white/15',
  ...
  check: 'mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full bg-indigo-500 text-white',
};
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div class="${styles.previewLineShort}"></div>
                  </div>
                </div>
