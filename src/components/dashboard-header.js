...
const styles = {
  container: `mb-8 sm:mb-10 flex items-center justify-between gap-4 rounded-2xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-800/60 px-4 py-4 sm:px-6 sm:py-5 shadow-xl shadow-black/20 backdrop-blur-md`,
