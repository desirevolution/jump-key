...
const styles = {
  ...
  iconDefault: `bg-slate-700/60 text-indigo-400 ring-slate-600/70 group-hover:-translate-y-0.5 group-hover:bg-indigo-500/15 group-hover:text-slate-50 group-hover:ring-indigo-500/40`,
